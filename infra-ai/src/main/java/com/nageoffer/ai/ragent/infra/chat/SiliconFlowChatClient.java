...
public class SiliconFlowChatClient implements ChatClient {
    ...
    private JsonArray buildContentParts(ChatMessage message) {
        JsonArray parts = new JsonArray();
        for (ChatMessage.ContentPart part : message.getParts()) {
    ...
    private String extractMessageContent(com.google.gson.JsonElement content) {
        if (content == null || content.isJsonNull()) {
            throw new ModelClientException("SiliconFlow 鍝嶅簲缂哄皯 content", ModelClientErrorType.INVALID_RESPONSE, null);
        }
        ...
        throw new ModelClientException("SiliconFlow content 鏍煎紡涓嶆敮鎸?", ModelClientErrorType.INVALID_RESPONSE, null);
    }
