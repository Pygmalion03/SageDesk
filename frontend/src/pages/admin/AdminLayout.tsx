...
import { APP_REPO_URL, APP_SHORT_NAME, APP_TAGLINE } from "@/config/app";
          ...
          <div className={cn("flex items-center gap-3", collapsed && "justify-center")}>
            ...
            {!collapsed && (
              <div className="min-w-0">
                <h1 className="admin-sidebar__title">{APP_SHORT_NAME} 管理后台</h1>
                <p className="admin-sidebar__subtitle">{APP_TAGLINE}</p>
              </div>
            )}
          </div>
        </div>
